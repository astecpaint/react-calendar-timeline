...
exports["default"] = exports.DEFAULT_WIDTH_SIDEBAR = exports.DEFAULT_SCROLL_TOP = exports.DEFAULT_ROW_DISPLAYED = exports.DEFAULT_HEIGHT_ROW_PROCESS_BASIC = exports.DEFAULT_HEIGHT_ROW = exports.DEFAULT_HEIGHT_HEADER_PROCESS_BASIC = exports.DEFAULT_HEIGHT_HEADER = exports.DEFAULT_BUFFER_ROW_IN_SIDEBAR = exports.DEFAULT_BUFFER_ROW = exports.DEFAULT_BUFFER_CANVAS = void 0;
...
var DEFAULT_HEIGHT_ROW = exports.DEFAULT_HEIGHT_ROW = 64,
  DEFAULT_HEIGHT_ROW_PROCESS_BASIC = exports.DEFAULT_HEIGHT_ROW_PROCESS_BASIC = 60,
  DEFAULT_HEIGHT_HEADER = exports.DEFAULT_HEIGHT_HEADER = 112,
  DEFAULT_HEIGHT_HEADER_PROCESS_BASIC = exports.DEFAULT_HEIGHT_HEADER_PROCESS_BASIC = 80,
  DEFAULT_ROW_DISPLAYED = exports.DEFAULT_ROW_DISPLAYED = 12,
  DEFAULT_BUFFER_ROW = exports.DEFAULT_BUFFER_ROW = 1,
  DEFAULT_SCROLL_TOP = exports.DEFAULT_SCROLL_TOP = 0,
  DEFAULT_BUFFER_ROW_IN_SIDEBAR = exports.DEFAULT_BUFFER_ROW_IN_SIDEBAR = 1.5,
  DEFAULT_BUFFER_CANVAS = exports.DEFAULT_BUFFER_CANVAS = 3,
  DEFAULT_WIDTH_SIDEBAR = exports.DEFAULT_WIDTH_SIDEBAR = 248;
var ReactCalendarTimeline = exports["default"] = /*#__PURE__*/function (_Component) {
  function ReactCalendarTimeline(_props) {
    ...
    _defineProperty(_this, "resize", function () {
      var _this$container$getBo, _this$container;
      var props = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _this.props;
      var offsetWidth = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
      var containerWidth = (_this$container$getBo = (_this$container = _this.container) === null || _this$container === void 0 || (_this$container = _this$container.getBoundingClientRect()) === null || _this$container === void 0 ? void 0 : _this$container.width) !== null && _this$container$getBo !== void 0 ? _this$container$getBo : 0;
      var width = containerWidth - props.sidebarWidth - props.rightSidebarWidth + offsetWidth;
    ...
    _defineProperty(_this, "handleScroll", function (e) {
      var _this$scrollComponent, _this$scrollComponent2;
      var distanceScroll = (((_this$scrollComponent = _this.scrollComponentTemporary) === null || _this$scrollComponent === void 0 ? void 0 : _this$scrollComponent.scrollLeft) - _this.scrollLeftTemporary) / 3.2;
      if (!_this.isScrolling) {
        _this.isScrolling = true;
      } else {
        _this.onScroll(_this.scrollComponent.scrollLeft + Number(distanceScroll));
      }
      _this.scrollLeftTemporary = (_this$scrollComponent2 = _this.scrollComponentTemporary) === null || _this$scrollComponent2 === void 0 ? void 0 : _this$scrollComponent2.scrollLeft;
    });
     ...
     */
    _defineProperty(_this, "handleClickScrollPrev", function (e) {
      if (_this.scrollComponentTemporary) {
        var distanceScroll = _this.scrollComponentTemporary.scrollLeft - _this.scrollComponentTemporary.scrollWidth / 2;
        _this.scrollComponentTemporary.scroll({
          left: distanceScroll
        });
      }
    });
     ...
     * @param {object} e - object click event
     */
    _defineProperty(_this, "handleClickScrollNext", function (e) {
      if (_this.scrollComponentTemporary) {
        var distanceScroll = _this.scrollComponentTemporary.scrollLeft + _this.scrollComponentTemporary.scrollWidth / 2;
        _this.scrollComponentTemporary.scroll({
          left: distanceScroll
    ...
    _defineProperty(_this, "getItemDisplayPosition", function () {
      var _this$props$groups;
      var bufferRowInSidebar = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : DEFAULT_BUFFER_ROW;
      var scrollTop = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _this.props.scrollTop;
      var numberOfRowDisplayed = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : _this.props.defaultRowDisplayed;
      var bufferRow = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : _this.props.defaultBufferRow;
      var numberOfMaxItemTopOrBottom = Math.round(numberOfRowDisplayed * bufferRow),
        newBufferInSidebar = bufferRowInSidebar - 1;
      var numberOfItemTopHided = (scrollTop - DEFAULT_HEIGHT_HEADER_PROCESS_BASIC) / DEFAULT_HEIGHT_ROW_PROCESS_BASIC;
      var headerHeight = _this.props.isScheduleScreen ? DEFAULT_HEIGHT_HEADER : DEFAULT_HEIGHT_HEADER_PROCESS_BASIC;
      var indexFirstItemDisplayed = (_this$props$groups = _this.props.groups) === null || _this$props$groups === void 0 || (_this$props$groups = _this$props$groups.filter(function (group) {
        return (group === null || group === void 0 ? void 0 : group.isMerge) || !(group !== null && group !== void 0 && group.isMerge) && !(group !== null && group !== void 0 && group.isHide);
      })) === null || _this$props$groups === void 0 ? void 0 : _this$props$groups.findIndex(function (group) {
        return (group === null || group === void 0 ? void 0 : group.offsetHeight) >= scrollTop - headerHeight;
      });
      if (indexFirstItemDisplayed !== -1) {
        numberOfItemTopHided = _this.props.isScheduleScreen ? indexFirstItemDisplayed - 1 : indexFirstItemDisplayed;
      }
      if (!scrollTop || numberOfItemTopHided < numberOfMaxItemTopOrBottom) {
        return {
          start: 0,
          end: numberOfRowDisplayed + numberOfMaxItemTopOrBottom + numberOfMaxItemTopOrBottom * newBufferInSidebar - 1
        };
      }
      var page = Math.floor(numberOfItemTopHided / numberOfMaxItemTopOrBottom);
      var start = (page - 1) * numberOfMaxItemTopOrBottom,
     ...
     */
    _defineProperty(_this, "setCurrentGroupMove", function (group) {
      _this.setState({
    ...
    _this.isScrolling = false;
    _this.isShowSidebarTemporary = null;
    _this.isScrollDisabled = false;
    /* eslint-enable */
    return _this;
  }
  ...
  return _createClass(ReactCalendarTimeline, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      if (this.isShowSidebarTemporary !== null && this.props.isShowSidebar !== this.isShowSidebarTemporary) {
        this.isScrollDisabled = true;
        var offsetWidth = this.props.isShowSidebar ? -DEFAULT_WIDTH_SIDEBAR : DEFAULT_WIDTH_SIDEBAR;
        this.resize(this.props, offsetWidth);
        this.setState({
          visibleTimeStart: prevState.visibleTimeStart
        });
      ...
      if (this.props.onBoundsChange && this.state.canvasTimeStart !== prevState.canvasTimeStart) {
        if (this.props.isReCalculateCanvasTime && this.props.defaultTimeStart && this.props.defaultTimeEnd) {
          var _getCanvasBoundariesF3 = (0, _calendar.getCanvasBoundariesFromVisibleTime)(this.props.defaultTimeStart.valueOf(), this.props.defaultTimeEnd.valueOf(), DEFAULT_BUFFER_CANVAS),
            _getCanvasBoundariesF4 = _slicedToArray(_getCanvasBoundariesF3, 2),
            canvasTimeStart = _getCanvasBoundariesF4[0],
            canvasTimeEnd = _getCanvasBoundariesF4[1];
          this.props.onBoundsChange(canvasTimeStart, canvasTimeEnd);
        } else {
          this.props.onBoundsChange(this.state.canvasTimeStart, this.state.canvasTimeStart + newZoom * DEFAULT_BUFFER_CANVAS);
        }
      }
    ...
    key: "rows",
    value: function rows(canvasWidth, groupHeights, groups, width, canvasTimeStart, canvasTimeEnd, visibleTimeStart, visibleTimeEnd, speedScrollHorizontal, isCreateTaskList, onCreateTask, isShowBgColorGroup, itemPositionDisplayed, isCreateTrackRecord) {
    ...
    key: "items",
    value: function items(canvasTimeStart, zoom, canvasTimeEnd, canvasWidth, minUnit, dimensionItems, groupHeights, groupTops, itemPositionDisplayed) {
    ...
    value: function sidebar(height, groupHeights) {
      var _this$props3 = this.props,
        ...
        buttonTooltipRenderer = _this$props3.buttonTooltipRenderer,
        isScheduleScreen = _this$props3.isScheduleScreen,
        onStartSort = _this$props3.onStartSort,
        isDragDrop = _this$props3.isDragDrop,
        isShowDataAssigned = _this$props3.isShowDataAssigned,
        viewOption = _this$props3.viewOption,
        isShowTrackRecord = _this$props3.isShowTrackRecord,
        isShowInforGemba = _this$props3.isShowInforGemba,
        defaultBufferRowSidebar = _this$props3.defaultBufferRowSidebar;
      var sidebarPositionDisplayed = this.getItemDisplayPosition(defaultBufferRowSidebar);
    ...
    value: function render() {
      ...
      var _this$props4 = this.props,
        ...
        timeSteps = _this$props4.timeSteps,
        traditionalZoom = _this$props4.traditionalZoom,
        buffer = _this$props4.buffer,
        canMoveChart = _this$props4.canMoveChart,
        speedScrollHorizontal = _this$props4.speedScrollHorizontal,
        isCreateTaskList = _this$props4.isCreateTaskList,
        onCreateTask = _this$props4.onCreateTask,
        isShowBgColorGroup = _this$props4.isShowBgColorGroup,
      ...
      var itemPositionDisplayed = this.getItemDisplayPosition();
      return /*#__PURE__*/_react["default"].createElement(_TimelineStateContext.TimelineStateProvider, {
        ...
        onMouseDown: function onMouseDown(event) {
          _this4.handleClickScrollPrev(event);
        }
      }), /*#__PURE__*/_react["default"].createElement("div", {
        className: "content"
        ...
        onMouseDown: function onMouseDown(event) {
          _this4.handleClickScrollNext(event);
        }
...
_defineProperty(ReactCalendarTimeline, "propTypes", {
  ...
  onStartSort: _propTypes["default"].func,
  openAddGroupForm: _propTypes["default"].func,
  canMoveChart: _propTypes["default"].bool,
  isCreateTaskList: _propTypes["default"].bool,
  onCreateTask: _propTypes["default"].func,
  isShowBgColorGroup: _propTypes["default"].bool,
  scrollContainer: _propTypes["default"].any,
  buttonTooltipRenderer: _propTypes["default"].any,
  isScheduleScreen: _propTypes["default"].bool,
  defaultRowDisplayed: _propTypes["default"].number,
  defaultBufferRow: _propTypes["default"].number,
  defaultBufferRowSidebar: _propTypes["default"].number,
  scrollTop: _propTypes["default"].number,
  isDragDrop: _propTypes["default"].object,
  isCreateTrackRecord: _propTypes["default"].bool,
  isShowDataAssigned: _propTypes["default"].bool,
  viewOption: _propTypes["default"].number,
  isShowTrackRecord: _propTypes["default"].bool,
  isReCalculateCanvasTime: _propTypes["default"].bool,
  isShowSidebar: _propTypes["default"].bool
});
_defineProperty(ReactCalendarTimeline, "defaultProps", {
  ...
  onCreateTask: function () {
    var _onCreateTask = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(group, startTime, endTime, isCreateTaskList) {
    ...
    function onCreateTask(_x, _x2, _x3, _x4) {
      return _onCreateTask.apply(this, arguments);
    }
    return onCreateTask;
  }(),
