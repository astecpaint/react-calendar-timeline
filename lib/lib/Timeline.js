...
var ReactCalendarTimeline = exports["default"] = /*#__PURE__*/function (_Component) {
  function ReactCalendarTimeline(_props) {
    ...
    _defineProperty(_this, "getItemDisplayPosition", function () {
      ...
      var defaultHeightHeader = _this.props.isScheduleScreen ? DEFAULT_HEIGHT_HEADER : DEFAULT_HEIGHT_HEADER_PROCESS_BASIC;
      var defaultHeightRow = _this.props.isScheduleScreen ? DEFAULT_HEIGHT_ROW : DEFAULT_HEIGHT_ROW_PROCESS_BASIC;
      var numberOfItemTopHided = (scrollTop - defaultHeightHeader) / defaultHeightRow;
      var newBufferInSidebar = bufferRowInSidebar - 1;
