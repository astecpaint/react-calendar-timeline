...
var ReactCalendarTimeline = exports["default"] = /*#__PURE__*/function (_Component) {
  ...
  return _createClass(ReactCalendarTimeline, [{
    ...
    key: "rows",
    value: function rows(canvasWidth, groupHeights, groups, width, canvasTimeStart, canvasTimeEnd, visibleTimeStart, visibleTimeEnd, speedScrollHorizontal, isCreateTaskList, onCreateTaskList, isShowBgColorGroup, itemPositionDisplayed) {
