...
exports["default"] = exports.DEFAULT_SCROLL_TOP = exports.DEFAULT_ROW_DISPLAYED = exports.DEFAULT_HEIGHT_ROW_PROCESS_BASIC = exports.DEFAULT_HEIGHT_ROW = exports.DEFAULT_HEIGHT_HEADER = exports.DEFAULT_BUFFER_ROW_IN_SIDEBAR = exports.DEFAULT_BUFFER_ROW = exports.DEFAULT_BUFFER_CANVAS = void 0;
...
var DEFAULT_HEIGHT_ROW = exports.DEFAULT_HEIGHT_ROW = 64,
  ...
  DEFAULT_BUFFER_ROW_IN_SIDEBAR = exports.DEFAULT_BUFFER_ROW_IN_SIDEBAR = 2,
...
var ReactCalendarTimeline = exports["default"] = /*#__PURE__*/function (_Component) {
  function ReactCalendarTimeline(_props) {
    ...
    _defineProperty(_this, "getItemDisplayPosition", function () {
      ...
      var numberOfMaxItemTopOrBottom = Math.round(numberOfRowDisplayed * bufferRow * bufferRowInSidebar);
      var numberOfItemTopHided = (scrollTop - DEFAULT_HEIGHT_HEADER) / DEFAULT_HEIGHT_ROW;
      if (!scrollTop || numberOfItemTopHided < numberOfMaxItemTopOrBottom / bufferRowInSidebar) {
        return {
          start: 0,
          end: numberOfRowDisplayed + numberOfMaxItemTopOrBottom - 1
        };
      }
      var start = Math.floor(numberOfItemTopHided) - numberOfMaxItemTopOrBottom; // start position: calculate number of item top will display at buffer block
      if (start < 0) start = 0; // check case value start of sidebar

      var end = start + numberOfRowDisplayed + numberOfMaxItemTopOrBottom * 2 - 1; // end position: position top + number of default display (between) + maxItem * 2 (top + max & bottom)
  ...
  return _createClass(ReactCalendarTimeline, [{
    ...
    value: function sidebar(height, groupHeights) {
      ...
      var sidebarPositionDisplayed = this.getItemDisplayPosition(DEFAULT_BUFFER_ROW_IN_SIDEBAR);
