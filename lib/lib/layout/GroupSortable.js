...
var GroupSortable = exports["default"] = /*#__PURE__*/function (_Component) {
  function GroupSortable(props) {
      ...
      switch (dragLevel) {
        ...
        default:
          groups.forEach(function (group) {
            ...
            var isSection = group === null || group === void 0 ? void 0 : group.isSection;
            if (isSection) {
    ...
    _defineProperty(_this, "setStyleDragElement", function (dragItemElms, dragContainer) {
      ...
      draggableButton.style.cssText = 'font-size: 16px; width: 16px; color: white; position: absolute; top: 50%; left: 12px; transform: translate(-50%, -50%); z-index: 100; pointer-events: none;';
    ...
    _defineProperty(_this, "onSortEnd", function (sort) {
      ...
      var _this$props3 = _this.props,
        ...
        actualGroups = _this$props3.actualGroups;
      ...
      if (dragLevel !== DRAG_LEVEL_GROUP.ONE && !isOverTop && !isOverBottom && newIndex > oldIndex && exactlyNewIndex !== oldIndex) {
        var groupDragged = actualGroups.find(function (group) {
          return group.index === exactlyNewIndex;
        });
        if (groupDragged) {
          var expanded = groupDragged.expanded,
            isSection = groupDragged.isSection,
            isCustomGroup = groupDragged.isCustomGroup,
            customId = groupDragged.customId,
            task = groupDragged.task;
          if (!expanded) {
            var numberOfChildGroup = 0;
            if (dragLevel === DRAG_LEVEL_GROUP.TWO) {
              if (isCustomGroup) {
                numberOfChildGroup = actualGroups.filter(function (group) {
                  var _group$task5;
                  return group.customId === customId && ((_group$task5 = group.task) === null || _group$task5 === void 0 ? void 0 : _group$task5.parent_id) === (task === null || task === void 0 ? void 0 : task.task_id);
                }).length;
              }
            } else {
              if (isSection) {
                numberOfChildGroup = actualGroups.filter(function (group) {
                  var _group$task6;
                  return group.customId === customId && ((_group$task6 = group.task) === null || _group$task6 === void 0 ? void 0 : _group$task6.task_id) !== (task === null || task === void 0 ? void 0 : task.task_id);
                }).length;
              }
            }
