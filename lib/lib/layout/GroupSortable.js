...
var GroupSortable = exports["default"] = /*#__PURE__*/function (_Component) {
  function GroupSortable(props) {
    ...
    _defineProperty(_this, "onSortOver", function (sort) {
      ...
      if (sort.newIndex % _Timeline.DEFAULT_ROW_DISPLAYED === 0 && sort.newIndex !== 0 && sort.newIndex !== (groups === null || groups === void 0 ? void 0 : groups.length) - 1) {
        isDragDrop.current = false;
        _this.state.loadMoreTimeoutId = setTimeout(function () {
          isDragDrop.current = true;
        }, 500);
      } else {
        isDragDrop.current = true;
        clearTimeout(_this.state.loadMoreTimeoutId);
        _this.state.loadMoreTimeoutId = -1;
      }
