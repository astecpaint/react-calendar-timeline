...
var GroupSortable = exports["default"] = /*#__PURE__*/function (_Component) {
  function GroupSortable(props) {
    ...
    _defineProperty(_this, "onSortEnd", function (sort) {
      ...
      sortOrderTaskList(_reactSortableHoc.arrayMove, sort.oldIndex, newIndex);
  ...
  return _createClass(GroupSortable, [{
    ...
    value: function shouldComponentUpdate(nextProps, nextState) {
      ...
      nextProps.groupIdKey === this.props.groupIdKey && nextProps.groupRightTitleKey === this.props.groupRightTitleKey && nextProps.groupTitleKey === this.props.groupTitleKey && nextProps.isRightSidebar === this.props.isRightSidebar && nextState.isDraging === this.state.isDraging && nextProps.isShowDragHandleButton === this.props.isShowDragHandleButton && nextProps.sidebarPositionDisplayed === this.props.sidebarPositionDisplayed && nextProps.viewOption === this.props.viewOption);
    }
  }, {
