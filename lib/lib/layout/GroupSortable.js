  ...
  function GroupSortable(props) {
    ...
    _defineProperty(_this, "updateBeforeSortStart", function (sort, event) {
      ...
      var _this$state = _this.state,
        ...
        rctItemElements = _this$state.rctItemElements,
        rctLockItemElements = _this$state.rctLockItemElements;
      ...
      if (parentId) {
        ...
        _this.handleDisableTransform(sort.index, groups, rctLockItemElements, rctItemElements, parentId);
    ...
    _defineProperty(_this, "onSortOver", function (sort) {
      ...
      if (sortParentId) {
        ...
        if ((newGroup === null || newGroup === void 0 || (_newGroup$task = newGroup.task) === null || _newGroup$task === void 0 ? void 0 : _newGroup$task.parent_id) !== sortParentId) {
          ...
          var lockedElement = document.querySelector(lockedIndexKey);
          if (lockedElement) {
     ...
     */
    _defineProperty(_this, "handleDisableTransform", function (sortIndex, groups, rctLockItemElements, rctItemElements, parentId) {
      var MIN_GROUPS_LENGTH = 2;
      var COMPENSATION_INDEX = 12;
      var _loop = function _loop(index) {
        var _newGroup$task8;
        var newIndexKey = '.rct_draggable_' + index;
        var newGroup = groups === null || groups === void 0 ? void 0 : groups.find(function (group) {
          return (group === null || group === void 0 ? void 0 : group.index) === index;
        });
        if (newGroup && (newGroup === null || newGroup === void 0 || (_newGroup$task8 = newGroup.task) === null || _newGroup$task8 === void 0 ? void 0 : _newGroup$task8.parent_id) !== parentId) {
          var lockedIndexKey = '.-sort-index-' + index;
          var lockedElement = document.querySelector(lockedIndexKey);
          if (lockedElement) {
            lockedElement.classList.add('disable-transform');
            if (!rctLockItemElements.has(lockedIndexKey)) {
      ...
      for (var index = Math.max(sortIndex - COMPENSATION_INDEX, 0); index < Math.min(sortIndex + COMPENSATION_INDEX, (groups === null || groups === void 0 ? void 0 : groups.length) - 1 || MIN_GROUPS_LENGTH); index++) {
        _loop(index);
      }
    });
