...
var GroupSortable = (exports['default'] = /*#__PURE__*/ (function(_Component) {
  function GroupSortable(props) {
    ...
    _defineProperty(_this, 'onSortStart', function(sort, event) {
      ...
      var dragItemElements = document.querySelectorAll(
    ...
    _defineProperty(_this, 'onSortEnd', function(sort) {
      ...
      if (sort.oldIndex !== sort.newIndex) {
        var groupFilter = groups.filter(function(group) {
          var _group$task
          return (
            !(group !== null && group !== void 0 && group.isEmptyGroup) &&
            !(
              group !== null &&
              group !== void 0 &&
              (_group$task = group.task) !== null &&
              _group$task !== void 0 &&
              _group$task.isEmptySubGroup
            )
          )
        })
        var newList = (0, _reactSortableHoc.arrayMove)(
          groupFilter,
          sort.oldIndex,
          sort.newIndex
        )
    ...
    _defineProperty(_this, 'transformElements', function(
      elements,
      transformSize,
      delayDuration
    ) {
    ...
    _defineProperty(_this, 'clearTransformElements', function(elements) {
      for (var i = 0; i < elements.length; i++) {
        ...
        elements[i].style.transform = 'none' // fix bug ticket GP-15877. translate function will create a new viewport
    ...
    [
      {
        ...
        value: function shouldComponentUpdate(nextProps, nextState) {
          return !(
            (0, _generic.arraysEqual)(nextProps.groups, this.props.groups) &&
            (0, _generic.arraysEqual)(
              nextProps.groupHeights,
            ...
            nextProps.isShowDragHandleButton ===
              this.props.isShowDragHandleButton
          )
        }
      },
      {
        ...
        value: function render() {
          ...
          return /*#__PURE__*/ _react['default'].createElement(
            ...
            {
              className:
                isShowDragHandleButton && !isDraging
                  ? 'hover-show-sortable'
                  : ''
            },
            /*#__PURE__*/ _react['default'].createElement(
              _SortableContainer.SortableList,
              {
                useDragHandle: true,
                lockAxis: 'y',
    ...
    [
      {
        ...
        value: function getDerivedStateFromProps(nextProps, prevState) {
          ...
          if (!prevState.scrollContainer) {
            var scrollContainerElement = document.getElementById(
              (nextProps === null || nextProps === void 0
                ? void 0
