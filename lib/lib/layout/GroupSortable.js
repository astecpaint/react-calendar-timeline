...
var GroupSortable = exports["default"] = /*#__PURE__*/function (_Component) {
  function GroupSortable(props) {
      ...
      switch (dragLevel) {
        ...
        case DRAG_LEVEL_GROUP.TWO:
          ...
          groups.forEach(function (group) {
            ...
            var isTask = (group === null || group === void 0 ? void 0 : group.isCustomGroup) && !(group !== null && group !== void 0 && group.isTaskPQA) && (group === null || group === void 0 ? void 0 : group.customId) === (currentGroup === null || currentGroup === void 0 ? void 0 : currentGroup.customId);
            if (isTask) {
        ...
        default:
          groups.forEach(function (group) {
            ...
            var isPBTask = group === null || group === void 0 ? void 0 : group.isTaskPQA;
            if (isPBTask) {
    ...
    _defineProperty(_this, "getDragLevel", function (currentGroup) {
      ...
      if (currentGroup !== null && currentGroup !== void 0 && currentGroup.isCustomGroup && !(currentGroup !== null && currentGroup !== void 0 && currentGroup.isTaskPQA)) {
    ...
    _defineProperty(_this, "updateBeforeSortStart", function (sort, event) {
      ...
      var _this$props2 = _this.props,
        ...
        setCurrentGroupMove = _this$props2.setCurrentGroupMove;
    ...
    _defineProperty(_this, "onSortStart", function (sort, event) {
      var _this$state = _this.state,
        topGroup = _this$state.topGroup,
        bottomGroup = _this$state.bottomGroup,
      ...
      var sortableZone = {
        ...
        bottom: (bottomElmRect === null || bottomElmRect === void 0 ? void 0 : bottomElmRect.top) + offsetMouseToSidebarTop + scrollTop - (bottomGroup !== null && bottomGroup !== void 0 && bottomGroup.isEmptyGroup ? bottomElmRect.height : 0)
      };
    ...
    _defineProperty(_this, "autoScrollEvent", function (event) {
      ...
      var _this$state3 = _this.state,
        sortableZone = _this$state3.sortableZone,
        startDragToTopPosition = _this$state3.startDragToTopPosition,
        dragItemElms = _this$state3.dragItemElms,
        dragContainer = _this$state3.dragContainer,
        lastDragPosition = _this$state3.lastDragPosition,
        startScrollTop = _this$state3.startScrollTop;
    ...
    _defineProperty(_this, "onSortOver", function (sort) {
      ...
      var _this$state4 = _this.state,
        sortableGroups = _this$state4.sortableGroups,
        dragLevel = _this$state4.dragLevel,
        transformSize = _this$state4.transformSize;
    ...
    _defineProperty(_this, "onSortEnd", function (sort) {
      var _this$state5 = _this.state,
        topGroup = _this$state5.topGroup,
        bottomGroup = _this$state5.bottomGroup,
        loadMoreIntervalId = _this$state5.loadMoreIntervalId,
        lastSwappedIndex = _this$state5.lastSwappedIndex,
        dragLevel = _this$state5.dragLevel;
