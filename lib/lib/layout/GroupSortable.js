...
var GroupSortable = exports["default"] = /*#__PURE__*/function (_Component) {
  function GroupSortable(props) {
    ...
    _defineProperty(_this, "updateBeforeSortStart", function (sort, event) {
      ...
      if (parentId) {
        var subGroups = [];
        document.querySelectorAll('.sidebar-grouped-by-' + parentId).forEach(function (group) {
        ...
        if (subGroupsSize) {
          groupSortableConstraints.top = subGroups[1].getBoundingClientRect().top + scrollContainer.scrollTop;
          groupSortableConstraints.bottom = subGroups[subGroupsSize - 1].getBoundingClientRect().top + scrollContainer.scrollTop;
    ...
    _defineProperty(_this, "onSortMove", function (event) {
      ...
      if (((groupSortableConstraints === null || groupSortableConstraints === void 0 ? void 0 : groupSortableConstraints.top) > event.clientY + scrollContainer.scrollTop || (groupSortableConstraints === null || groupSortableConstraints === void 0 ? void 0 : groupSortableConstraints.bottom) < event.clientY + scrollContainer.scrollTop) && sortParentId) {
        var dragTransform = 0;
    ...
    _defineProperty(_this, "onSortOver", function (sort) {
      ...
      if (sort.newIndex % 12 === 0 && sort.newIndex !== 0 && sort.newIndex !== (groups === null || groups === void 0 ? void 0 : groups.length) - 1) {
      ...
      var _ref = itemElementsAtOldIndex || {
          firstIndex: undefined,
          lastIndex: undefined
        },
        oldFirstIndex = _ref.firstIndex,
        oldLastIndex = _ref.lastIndex;
    ...
    _defineProperty(_this, "autoScrollEvent", function (event) {
      ...
      if (((groupSortableConstraints === null || groupSortableConstraints === void 0 ? void 0 : groupSortableConstraints.top) > lastDragPosition + event.target.scrollTop || (groupSortableConstraints === null || groupSortableConstraints === void 0 ? void 0 : groupSortableConstraints.bottom) < lastDragPosition + event.target.scrollTop) && sortParentId) {
        var dragTransform = 0;
    ...
    _defineProperty(_this, "onSortEnd", function (sort) {
      ...
      if (sortParentId) {
        var _currentGroup$task2, _currentGroup$task3, _currentGroup$task4;
      ...
      _this.setState(_defineProperty(_defineProperty(_defineProperty({
        isDragging: false,
      ...
      }, "sortParentId", null), "currentGroup", null), "rctLockItemElements", new Map()));
    });
    /**
