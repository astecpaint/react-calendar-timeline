...
var GroupSortable = exports["default"] = /*#__PURE__*/function (_Component) {
  function GroupSortable(props) {
    ...
    _defineProperty(_this, "onSortStart", function (sort, event) {
      ...
      var currentGroup = groups === null || groups === void 0 ? void 0 : groups.find(function (group) {
        return (group === null || group === void 0 ? void 0 : group.index) === sort.index;
      });
      ...
      dragableButton.style.cssText = 'font-size: 16x; width: 16px; color: white; position: absolute; top: 30px; left: 15px; transform: translate(-50%, -50%); z-index: 83;';
    ...
    _defineProperty(_this, "onSortMove", function (event) {
      var _this$state = _this.state,
        ...
        groupPositionLimit = _this$state.groupPositionLimit,
        firstDragScrollTop = _this$state.firstDragScrollTop;
      var dragTransform = 0;
    ...
    _defineProperty(_this, "onSortOver", function (sort) {
      ...
      var _this$state2 = _this.state,
        rctItemElements = _this$state2.rctItemElements,
        sortParentId = _this$state2.sortParentId;
      ...
      if (sort.newIndex > sort.index) {
        if (sort.newIndex > sort.oldIndex && sort.newIndex >= rctItemElements.get(newIndexKey).lastIndex || sort.newIndex < sort.oldIndex && sort.newIndex > rctItemElements.get(newIndexKey).firstIndex && sort.newIndex < rctItemElements.get(newIndexKey).lastIndex) {
          _this.transformElements(rctItemElements.get(newIndexKey), -60, DEFAULT_SORTABLE_DURATION);
        } else if (sort.newIndex < sort.oldIndex && sort.newIndex <= rctItemElements.get(oldIndexKey).firstIndex) {
    ...
    _defineProperty(_this, "autoScrollEvent", function (event) {
      var _this$state3 = _this.state,
        ...
        lastDragPosition = _this$state3.lastDragPosition,
        displacementSize = _this$state3.displacementSize,
        groupPositionLimit = _this$state3.groupPositionLimit,
    ...
    _defineProperty(_this, "onSortEnd", function (sort) {
      var _this$state4 = _this.state,
        scrollContainer = _this$state4.scrollContainer,
        rctItemElements = _this$state4.rctItemElements,
        dragItemElements = _this$state4.dragItemElements;
      var sortOrderTaskList = _this.props.sortOrderTaskList;
      ...
      if (sort.oldIndex !== sort.newIndex) {
        sortOrderTaskList(_reactSortableHoc.arrayMove, sort.oldIndex, sort.newIndex);
      }
    ...
    _defineProperty(_this, "transformElements", function (groupElements, transformSize, delayDuration) {
      var elements = document.querySelectorAll(groupElements.groupMove);
  ...
  return _createClass(GroupSortable, [{
    ...
    value: function shouldComponentUpdate(nextProps, nextState) {
      ...
      nextProps.groupIdKey === this.props.groupIdKey && nextProps.groupRightTitleKey === this.props.groupRightTitleKey && nextProps.groupTitleKey === this.props.groupTitleKey && nextProps.isRightSidebar === this.props.isRightSidebar && nextState.isDraging === this.state.isDraging && nextProps.isShowDragHandleButton === this.props.isShowDragHandleButton && nextProps.sidebarPositionDisplayed === this.props.sidebarPositionDisplayed);
    }
  }, {
    ...
    value: function render() {
      ...
      var _this$props3 = this.props,
        ...
        groupHeights = _this$props3.groupHeights,
        isRightSidebar = _this$props3.isRightSidebar,
        groupTitleKey = _this$props3.groupTitleKey,
        groupRightTitleKey = _this$props3.groupRightTitleKey,
        groupIdKey = _this$props3.groupIdKey,
        groupRenderer = _this$props3.groupRenderer,
        ...
        sidebarPositionDisplayed = _this$props3.sidebarPositionDisplayed;
