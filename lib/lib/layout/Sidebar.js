...
var Sidebar = exports["default"] = /*#__PURE__*/function (_Component) {
  ...
  return _createClass(Sidebar, [{
    ...
    value: function render() {
      var _this$props$groups$fi, _this$props$groups;
      ...
      var newGroups = (_this$props$groups$fi = (_this$props$groups = this.props.groups) === null || _this$props$groups === void 0 ? void 0 : _this$props$groups.filter(function (group) {
      ...
      })) !== null && _this$props$groups$fi !== void 0 ? _this$props$groups$fi : [];
