...
var Sidebar = exports["default"] = /*#__PURE__*/function (_Component) {
  ...
  return _createClass(Sidebar, [{
    ...
    value: function shouldComponentUpdate(nextProps) {
      ...
      nextProps.isShowInforGemba === this.props.isShowInforGemba && nextProps.isShowDragHandleButton === this.props.isShowDragHandleButton && nextProps.isScheduleScreen === this.props.isScheduleScreen && (0, _generic.deepObjectCompare)(this.props.sidebarPositionDisplayed, nextProps.sidebarPositionDisplayed) && nextProps.isShowDataAssigned === this.props.isShowDataAssigned && nextProps.viewOption === this.props.viewOption && nextProps.isShowTrackRecord === this.props.isShowTrackRecord);
    }
  }, {
    ...
    value: function render() {
      ...
      var _this$props = this.props,
        ...
        isDragDrop = _this$props.isDragDrop,
        isShowDataAssigned = _this$props.isShowDataAssigned,
        viewOption = _this$props.viewOption,
        isShowTrackRecord = _this$props.isShowTrackRecord,
        setCurrentGroupMove = _this$props.setCurrentGroupMove,
      ...
      var groupLines = newGroupDisplayed.map(function (group, index) {
        ...
        return /*#__PURE__*/_react["default"].createElement("div", {
          ...
          className: "rct-sidebar-row rct-sidebar-row-".concat(index % 2 === 0 ? 'even' : 'odd', " ").concat(!!(group !== null && group !== void 0 && group.isMerge) && !!(group !== null && group !== void 0 && group.isCustomGroup) || group !== null && group !== void 0 && group.isSection ? 'rct-sidebar-row-full-width' : ''),
          style: elementStyle
      ...
      var newGroups = (_groups$filter = groups.filter(function (group) {
        return !(group !== null && group !== void 0 && group.isHide) && !(group !== null && group !== void 0 && group.isMerge) || (group === null || group === void 0 ? void 0 : group.isMerge);
...
_defineProperty(Sidebar, "propTypes", {
  ...
  setCurrentGroupMove: _propTypes["default"].func
});