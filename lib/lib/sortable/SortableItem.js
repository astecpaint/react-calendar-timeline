...
var SortableItemClass = /*#__PURE__*/function (_PureComponent) {
  function SortableItemClass(props) {
    ...
    _defineProperty(_this, "getSortableClassName", function (group) {
      ...
      var parentId = group === null || group === void 0 || (_group$task = group.task) === null || _group$task === void 0 ? void 0 : _group$task.parent_id;
      var taskId = group === null || group === void 0 || (_group$task2 = group.task) === null || _group$task2 === void 0 ? void 0 : _group$task2.task_id;
      ...
      if (group !== null && group !== void 0 && group.isCustomGroup && !(group !== null && group !== void 0 && group.isTaskPQA) || parentId && taskId) {
  ...
  return _createClass(SortableItemClass, [{
    ...
    value: function render() {
      var _group$task3, _group$task4, _group$task5, _group$task6, _group$task7;
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
        className: sortableClassNameStr + ' rct-sidebar-row rct-sidebar-row-' + (group.index % 2 === 0 ? 'even' : 'odd') + (group !== null && group !== void 0 && group.isTaskPQA ? ' rct-sidebar-row-full-width' : ''),
        style: {
      ...
      }, (currentIndex >= start && currentIndex <= end || (group === null || group === void 0 ? void 0 : group.isAddinationForm)) && /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, this.state.groupChildren, !(group !== null && group !== void 0 && group.isEmptyGroup) && !(group !== null && group !== void 0 && (_group$task3 = group.task) !== null && _group$task3 !== void 0 && _group$task3.isEmptySubGroup) && /*#__PURE__*/_react["default"].createElement("div", {
        className: 'rct-drag-drop' + ((group === null || group === void 0 || (_group$task4 = group.task) === null || _group$task4 === void 0 ? void 0 : _group$task4.parent_id) != null && (group === null || group === void 0 || (_group$task5 = group.task) === null || _group$task5 === void 0 ? void 0 : _group$task5.parent_id) != undefined ? ' -sub' : '') + (group !== null && group !== void 0 && group.isTaskPQA ? ' -task-pqa' : '')
      }, /*#__PURE__*/_react["default"].createElement("div", {
        className: 'rct-siderbar-control-btns' + ((group === null || group === void 0 || (_group$task6 = group.task) === null || _group$task6 === void 0 ? void 0 : _group$task6.parent_id) != null && (group === null || group === void 0 || (_group$task7 = group.task) === null || _group$task7 === void 0 ? void 0 : _group$task7.parent_id) != undefined ? ' -sub' : '')
      }, /*#__PURE__*/_react["default"].createElement(DragHandle, {
        groupIndex: group === null || group === void 0 ? void 0 : group.index
      }), !(group !== null && group !== void 0 && group.isTaskPQA) && /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, ButtonTooltip ? /*#__PURE__*/_react["default"].createElement(ButtonTooltip, {
        group: group,
