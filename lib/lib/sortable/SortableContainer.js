...
var SortableListClass = /*#__PURE__*/function (_Component) {
  ...
  return _createClass(SortableListClass, [{
    ...
    value: function shouldComponentUpdate(nextProps) {
      return !((0, _generic.arraysEqual)(nextProps.groups, this.props.groups) && nextProps.groupIdKey === this.props.groupIdKey && nextProps.groupRightTitleKey === this.props.groupRightTitleKey && nextProps.groupTitleKey === this.props.groupTitleKey && nextProps.isRightSidebar === this.props.isRightSidebar && (0, _generic.deepObjectCompare)(nextProps.sidebarPositionDisplayed, this.props.sidebarPositionDisplayed) && nextProps.viewOption === this.props.viewOption && nextProps.isShowTrackRecord === this.props.isShowTrackRecord);
    }
  }, {
    key: "render",
