...
var DateHeader = /*#__PURE__*/function (_React$Component) {
  ...
  return _createClass(DateHeader, [{
    ...
    value: function shouldComponentUpdate(nextProps) {
      return !(nextProps.unit === this.props.unit && nextProps.style === this.props.style && nextProps.height === this.props.height && nextProps.timelineUnit === this.props.timelineUnit && nextProps.labelFormat === this.props.labelFormat);
    }
  }, {
    key: "render",
