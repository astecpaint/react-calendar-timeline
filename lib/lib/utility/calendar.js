...
function checkValueDate(value) {
  if (!value || value === null || value === 'Invalid date' || value === '' || value === '0000-00-00' || value === '0000-00-00 00:00:00') {
    return null;
  }
  var momentVal = (0, _moment["default"])(value);
  if (_.isNaN(momentVal) || momentVal === 'Invalid date' || momentVal === '' || momentVal === '0000-00-00' || momentVal === '0000-00-00 00:00:00') {
    return null;
  }
  return momentVal;
}
