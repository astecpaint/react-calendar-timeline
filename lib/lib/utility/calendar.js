...
exports.checkValueDate = checkValueDate;
 ...
 */
function getGroupOrders(groups, keys, itemPositionDisplayed) {
  ...
  if (itemPositionDisplayed) {
    ...
    for (var i = 0; i < groups.length; i++) {
      var group = groups[i];
      var isValidGroup = !(group !== null && group !== void 0 && group.isHide) && !(group !== null && group !== void 0 && group.isMerge) || !!(group !== null && group !== void 0 && group.isMerge);
      if (!isValidGroup) end++;
    ...
    for (var _i = 0; _i < groups.length; _i++) {
      groupOrders[(0, _generic._get)(groups[_i], groupIdKey)] = {
        index: _i,
        group: groups[_i]
      };
    }
...
function getGroupedItems(items, groupOrders) {
  ...
  for (var _i2 = 0; _i2 < items.length; _i2++) {
    if (items[_i2].dimensions.order !== undefined) {
      var groupItem = groupedItems[items[_i2].dimensions.order.index];
      if (groupItem) {
        groupItem.items.push(items[_i2]);
      }
    }
  }
  return groupedItems;
...
function stackAll(itemsDimensions, groupOrders, lineHeight, stackItems) {
  ...
  for (var index in groupedItems) {
    ...
    if (!(group !== null && group !== void 0 && group.isHide) && !(group !== null && group !== void 0 && group.isMerge) || group !== null && group !== void 0 && group.isMerge) {
      //  groupHeights.push(0)
      if (group.height) {
...
function checkValueDate(value) {
  if (!value || value === null || value === 'Invalid date' || value === '' || value === '0000-00-00' || value === '0000-00-00 00:00:00') return null;
  var momentVal = (0, _moment["default"])(value);
  if (_.isNaN(momentVal) || momentVal === 'Invalid date' || momentVal === '' || momentVal === '0000-00-00' || momentVal === '0000-00-00 00:00:00') return null;
  return momentVal;
}