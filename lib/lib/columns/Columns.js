...
var Columns = /*#__PURE__*/function (_Component) {
  ...
  return _createClass(Columns, [{
    ...
    value: function render() {
      ...
      var newMinUnit = Number(viewOption) === VALUE_DISPLAYED.SIX_MONTH ? VALUE_DISPLAYED.WEEK : VALUE_DISPLAYED.DAY;
      var lines = [];
      (0, _calendar.iterateTimes)(canvasTimeStart, canvasTimeEnd, newMinUnit, timeSteps, function (time, nextTime) {
