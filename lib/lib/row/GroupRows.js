...
var GroupRows = exports["default"] = /*#__PURE__*/function (_Component) {
  ...
  return _createClass(GroupRows, [{
    ...
    value: function shouldComponentUpdate(nextProps) {
      return !(nextProps.canvasWidth === this.props.canvasWidth && nextProps.lineCount === this.props.lineCount && nextProps.groupHeights === this.props.groupHeights && nextProps.groups === this.props.groups && nextProps.isScheduleScreen === this.props.isScheduleScreen && (0, _generic.deepObjectCompare)(this.props.itemPositionDisplayed, nextProps.itemPositionDisplayed));
    }
  }, {
    key: "render",
    value: function render() {
      var _this$props = this.props,
        ...
        onCreateTaskList = _this$props.onCreateTaskList,
