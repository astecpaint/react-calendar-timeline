...
var HEIGHT_TASK = 23,
  ...
  HEIGHT_TRACK_RECORD = 18,
  MARGIN_TOP_OF_TRACK_RECORD = 30,
  DEFAULT_HOUR = 23,
...
var GroupRow = /*#__PURE__*/function (_PureComponent) {
  function GroupRow(props) {
    var _this;
    _classCallCheck(this, GroupRow);
    _this = _callSuper(this, GroupRow, [props]);
    _defineProperty(_this, "getWidthByTime", function () {
      var _dataTimeEnd$hour, _dataTimeEnd$minute, _dataTimeEnd$second, _dataTimeEnd$millisec;
      ...
      var dataTimeEnd = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
      var isConvertTime = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
      ...
      var startTime = startDate,
        endTime = endDate !== null && endDate !== void 0 ? endDate : startTime;
      var hour = (_dataTimeEnd$hour = dataTimeEnd === null || dataTimeEnd === void 0 ? void 0 : dataTimeEnd.hour) !== null && _dataTimeEnd$hour !== void 0 ? _dataTimeEnd$hour : DEFAULT_HOUR,
        minute = (_dataTimeEnd$minute = dataTimeEnd === null || dataTimeEnd === void 0 ? void 0 : dataTimeEnd.minute) !== null && _dataTimeEnd$minute !== void 0 ? _dataTimeEnd$minute : DEFAULT_MINUTE_SECOND_MILLISECOND,
        second = (_dataTimeEnd$second = dataTimeEnd === null || dataTimeEnd === void 0 ? void 0 : dataTimeEnd.second) !== null && _dataTimeEnd$second !== void 0 ? _dataTimeEnd$second : DEFAULT_MINUTE_SECOND_MILLISECOND,
        millisecond = (_dataTimeEnd$millisec = dataTimeEnd === null || dataTimeEnd === void 0 ? void 0 : dataTimeEnd.millisecond) !== null && _dataTimeEnd$millisec !== void 0 ? _dataTimeEnd$millisec : DEFAULT_MINUTE_SECOND_MILLISECOND;
      if (isConvertTime) {
        startTime = (0, _moment["default"])((0, _moment["default"])(startTime).format('YYYY-MM-DD')).valueOf();
        endTime = (0, _moment["default"])((0, _moment["default"])(endTime).format('YYYY-MM-DD')).set({
          hour: hour,
          minute: minute,
          second: second,
      ...
      var startPosition = (0, _calendar.calculateXPositionForTime)(canvasTimeStart, canvasTimeEnd, canvasWidth, startTime);
      var endPosition = (0, _calendar.calculateXPositionForTime)(canvasTimeStart, canvasTimeEnd, canvasWidth, endTime);
      return endPosition - startPosition;
    });
    _defineProperty(_this, "renderCreateTask", function (group, countTime, left, width, isCreatingPositionAbove, isCreateTrackRecord, endTimeTmp, startTimeTaskCreatingActual) {
      var _group$task$task_colo, _group$task, _group$task$track_rec, _group$task2;
      ...
      var minWidth = _this.getWidthByTime();
      var isTrackRecordTypeDetail = isCreateTrackRecord && !isCreatingPositionAbove && (group === null || group === void 0 ? void 0 : group.regis_track_record_type) === TYPE_CREATE_TRACK_RECORD.DETAIL;
      var newWidth = width,
        newLeft = left;
      if (isTrackRecordTypeDetail) {
        var hour = (0, _moment["default"])(startTimeTaskCreatingActual).format('HH');
        if (endTimeTmp <= startTimeTaskCreatingActual && hour < DEFAULT_MOUSE_MOVE_DISTANCE) {
      ...
      return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, isCreatingPositionAbove ? /*#__PURE__*/_react["default"].createElement("div", {
        style: {
          ...
          backgroundColor: (_group$task$task_colo = group === null || group === void 0 || (_group$task = group.task) === null || _group$task === void 0 ? void 0 : _group$task.task_color) !== null && _group$task$task_colo !== void 0 ? _group$task$task_colo : isMerge ? BG_COLOR_TASK : BG_COLOR_SUB_TASK,
          borderRadius: '6px',
          paddingLeft: '5px',
          display: 'flex',
          alignItems: 'center',
        ...
        style: {
          ...
          width: "".concat(newWidth, "px"),
          minWidth: "".concat(minWidth, "px"),
          backgroundColor: (_group$task$track_rec = group === null || group === void 0 || (_group$task2 = group.task) === null || _group$task2 === void 0 ? void 0 : _group$task2.track_record_color) !== null && _group$task$track_rec !== void 0 ? _group$task$track_rec : isMerge ? BG_COLOR_TRACK_RECORD : BG_COLOR_SUB_TRACK_RECORD,
          zIndex: 2
        }
      }));
    });
    _defineProperty(_this, "renderBgColor", function (isShowBgColorGroup, group, canvasTimeStart, canvasTimeEnd, canvasWidth, isScheduleScreen) {
      var _group$task3, _group$task4, _group$task5;
      var isHide = group.isHide,
        ...
        isMerge = group.isMerge,
        gemba_color = group.gemba_color,
        isTaskList = group.isTaskList,
        isSubTask = group.isSubTask;
      ...
      var newIsHide = isMerge || !isCustomGroup && !isTaskList && !isSubTask ? !expanded : isHide;
      if (!isScheduleScreen) {
      ...
      var left = (0, _calendar.calculateXPositionForTime)(canvasTimeStart, canvasTimeEnd, canvasWidth, (0, _moment["default"])(minBeginDate).valueOf());
      var width = _this.getWidthByTime(minBeginDate, maxEndDate);
      var bgColor = isScheduleScreen ? gemba_color : isCustomGroup ? task_color : parent_task_color;
      var opacity = isScheduleScreen ? 1 : bgColor ? OPACITY_ROW_TASK : 1;
      return /*#__PURE__*/_react["default"].createElement("div", {
        className: ' -sort-index-' + (group === null || group === void 0 ? void 0 : group.index) + (group !== null && group !== void 0 && (_group$task3 = group.task) !== null && _group$task3 !== void 0 && _group$task3.parent_id ? ' group-move-' + (group === null || group === void 0 || (_group$task4 = group.task) === null || _group$task4 === void 0 ? void 0 : _group$task4.parent_id) : ' group-move-' + (group === null || group === void 0 || (_group$task5 = group.task) === null || _group$task5 === void 0 ? void 0 : _group$task5.task_id)),
        style: {
          position: 'absolute',
          width: width,
          top: 0,
    ...
    _defineProperty(_this, "calendarScrollWithTime", function (scrollLeft) {
      var _this$props2 = _this.props,
        ...
        speedScrollHorizontal = _this$props2.speedScrollHorizontal;
    ...
    _defineProperty(_this, "handleMouseDown", function (e) {
      ...
      if (!!(e !== null && e !== void 0 && e.button)) return;
      var _this$props3 = _this.props,
        group = _this$props3.group,
        isCreateTaskList = _this$props3.isCreateTaskList,
        getTimeFromRowClickEvent = _this$props3.getTimeFromRowClickEvent,
      ...
      var isHasTrackRecord = (group === null || group === void 0 ? void 0 : group.regis_track_record_type) === TYPE_CREATE_TRACK_RECORD.DEFAULT && (task === null || task === void 0 || (_task$track_record_li = task.track_record_list) === null || _task$track_record_li === void 0 ? void 0 : _task$track_record_li.some(function (trackRecord) {
        return !!(0, _calendar.checkValueDate)(trackRecord === null || trackRecord === void 0 ? void 0 : trackRecord.begin_date) && !!(0, _calendar.checkValueDate)(trackRecord === null || trackRecord === void 0 ? void 0 : trackRecord.end_date);
      }));
      ...
      if (_this.state.countTime >= COUNT_TIME || !!_this.startTimeTaskCreating) {
        _this.handleClear();
      }
      _this.startTimeTaskCreatingActual = getTimeFromRowClickEvent(e);
    ...
    _defineProperty(_this, "handleClear", function () {
      ...
      _this.startTimeTaskCreatingActual = 0;
      _this.endTimeTmp = 0;
    ...
    _defineProperty(_this, "handleMouseUp", function () {
      var _this$props4 = _this.props,
        ...
        isCreateTrackRecord = _this$props4.isCreateTrackRecord;
      if (!isCreateTaskList && !isCreateTrackRecord) return;
      _this.handleClear();
    });
    _defineProperty(_this, "handleCreateOnMouseUp", /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
        var _this$props5, isCreateTaskList, group, getTimeFromRowClickEvent, isCreateTrackRecord, endTime, endDate, hours, maxEndDate, startDate, _endDate, minStartDate, _hours;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _this$props5 = _this.props, isCreateTaskList = _this$props5.isCreateTaskList, group = _this$props5.group, getTimeFromRowClickEvent = _this$props5.getTimeFromRowClickEvent, isCreateTrackRecord = _this$props5.isCreateTrackRecord;
            ...
            case 3:
              if (!(_this.state.countTime < COUNT_TIME || !_this.startTimeTaskCreating || !_this.isMouseMove)) {
                _context.next = 6;
                break;
              }
              _this.handleClear();
            ...
            case 6:
              ...
              endDate = endTime;
              hours = (0, _moment["default"])(endDate).format('HH');
              if (hours < DEFAULT_HOUR_HALF_DAY) {
                endDate = (0, _moment["default"])(endDate).add(-1, 'days').valueOf();
              }
              maxEndDate = (0, _moment["default"])(_this.startTimeTaskCreating).add(MAX_NUMBER_OF_DRAG_DAYS, 'days').valueOf();
              if (endDate > maxEndDate) {
                endDate = maxEndDate;
              }
              if ((0, _moment["default"])(endDate).isBefore(_this.startTimeTaskCreating)) {
                endDate = _this.startTimeTaskCreating;
              }
              _context.next = 16;
            ...
            case 18:
              ...
              _hours = (0, _moment["default"])(startDate).format('HH');
              if (_hours >= DEFAULT_HOUR_HALF_DAY) {
                startDate = (0, _moment["default"])(startDate).add(1, 'days').valueOf();
              }
              if (startDate < minStartDate) {
                startDate = minStartDate;
              }
              if ((0, _moment["default"])(_endDate).isBefore(startDate)) {
                _endDate = startDate;
              }
              _context.next = 27;
    ...
    _defineProperty(_this, "isValidMouseMove", function (timeEnd, timeDistance) {
      var expectDistance = _this.getWidthByTime(new Date(), null, timeDistance);
      var actualDistance = Math.abs(_this.getWidthByTime(_this.startTimeTaskCreatingActual, timeEnd, {}, false));
    ...
    _defineProperty(_this, "handleMouseMove", function (e) {
      var _this$props6 = _this.props,
        ...
        visibleTimeStart = _this$props6.visibleTimeStart,
        visibleTimeEnd = _this$props6.visibleTimeEnd,
        speedScrollHorizontal = _this$props6.speedScrollHorizontal,
        isCreateTaskList = _this$props6.isCreateTaskList,
        scrollRef = _this$props6.scrollRef,
        getTimeFromRowClickEvent = _this$props6.getTimeFromRowClickEvent,
        onDayToTime = _this$props6.onDayToTime,
        canvasWidth = _this$props6.canvasWidth,
        isCreateTrackRecord = _this$props6.isCreateTrackRecord,
        group = _this$props6.group;
      var timeStart = _this.startTimeTaskCreating,
        timeEnd = getTimeFromRowClickEvent(e);
      if (!isCreateTaskList && !isCreateTrackRecord || _this.state.countTime < COUNT_TIME || !scrollRef || !timeStart) {
        return;
      }
      if (isCreateTrackRecord && !_this.isCreatingPositionAbove && (group === null || group === void 0 ? void 0 : group.regis_track_record_type) === TYPE_CREATE_TRACK_RECORD.DETAIL && _this.isMouseMove) {
        return;
      }
      if (!_this.isMouseMove) {
        var isValid = _this.isValidMouseMove(timeEnd, {
      ...
      var newVisibleTimeStart = visibleTimeStart + onDayToTime(0.5),
  ...
  return _createClass(GroupRow, [{
    ...
    value: function render() {
      var _this$props7 = this.props,
        onContextMenu = _this$props7.onContextMenu,
        onDoubleClick = _this$props7.onDoubleClick,
        isEvenRow = _this$props7.isEvenRow,
        style = _this$props7.style,
        onClick = _this$props7.onClick,
        clickTolerance = _this$props7.clickTolerance,
        horizontalLineClassNamesForGroup = _this$props7.horizontalLineClassNamesForGroup,
        group = _this$props7.group,
        canvasTimeStart = _this$props7.canvasTimeStart,
        canvasTimeEnd = _this$props7.canvasTimeEnd,
        canvasWidth = _this$props7.canvasWidth,
        isShowBgColorGroup = _this$props7.isShowBgColorGroup,
        index = _this$props7.index,
        itemPositionDisplayed = _this$props7.itemPositionDisplayed,
        isScheduleScreen = _this$props7.isScheduleScreen,
        isCreateTrackRecord = _this$props7.isCreateTrackRecord;
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
        ...
        style: style
      }, index >= start && index <= end && /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, this.renderCreateTask(group, countTime, left, width, this.isCreatingPositionAbove, isCreateTrackRecord, this.endTimeTmp, this.startTimeTaskCreatingActual), this.renderBgColor(isShowBgColorGroup, group, canvasTimeStart, canvasTimeEnd, canvasWidth, isScheduleScreen)));
    }
  }]);
