...
var GroupRow = /*#__PURE__*/function (_PureComponent) {
  function GroupRow(props) {
    ...
    _defineProperty(_this, "getSortableClassName", function (group) {
      var TWO = _constants.SORTABLE_LAYER_CLASS_NAME.TWO,
      ...
      var sortableClassNames = [' sortable'];
    ...
    _defineProperty(_this, "renderBgColor", function (isShowBgColorGroup, group, canvasTimeStart, canvasTimeEnd, canvasWidth, isScheduleScreen) {
      ...
      var sortableClassNameStr = _this.getSortableClassName(group);
    ...
    _defineProperty(_this, "handleMouseDown", function (e) {
      ...
      if (!isCreateTaskList && !isCreateTrackRecord || isCreatingInvalidTask || isCreatingInvalidTrackRecord || isEmptyGroup || isAddinationForm || task !== null && task !== void 0 && task.isEmptySubGroup || isSection) {
        return;
      }
