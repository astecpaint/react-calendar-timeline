...
var GroupRow = /*#__PURE__*/function (_Component) {
  function GroupRow(props) {
    ...
    _defineProperty(_this, "renderCreateTask", function (group, countTime, left, width, isCreatingPositionAbove, canvasTimeStart, canvasTimeEnd, canvasWidth) {
      ...
      var startTimeToday = (0, _moment["default"])((0, _moment["default"])(new Date()).format('YYYY-MM-DD')).valueOf();
      var endTimeToday = (0, _moment["default"])(startTimeToday).set({
        hour: 23,
        minute: 59,
        second: 59,
        millisecond: 59
      }).valueOf();
      var startPosition = (0, _calendar.calculateXPositionForTime)(canvasTimeStart, canvasTimeEnd, canvasWidth, startTimeToday);
      var endPosition = (0, _calendar.calculateXPositionForTime)(canvasTimeStart, canvasTimeEnd, canvasWidth, endTimeToday);
      var minWidth = endPosition - startPosition;
  ...
  return _createClass(GroupRow, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
        ...
        style: style
      }, index >= start && index <= end && /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, this.renderCreateTask(group, countTime, left, width, this.isCreatingPositionAbove, canvasTimeStart, canvasTimeEnd, canvasWidth), this.renderBgColor(isShowBgColorGroup, group, canvasTimeStart, canvasTimeEnd, canvasWidth, isScheduleScreen)));
    }
  }]);
}(_react.Component);
