...
var GroupRow = /*#__PURE__*/function (_Component) {
  function GroupRow(props) {
    ...
    _defineProperty(_this, "renderBorderTaskList", function (group) {
      ...
      var topPositionOfTaskFirst = height - (HEIGHT_TASK * numberOfTaskList + PADDING_BOTTOM);
      return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, expanded && !isGroupLoading && task_list.map(function (task, taskIndex) {
        return /*#__PURE__*/_react["default"].createElement("div", {
          ...
          style: {
            position: 'absolute',
            top: "".concat(topPositionOfTaskFirst + HEIGHT_TASK * taskIndex, "px"),
            left: 0,
            width: '100%',
    ...
    _defineProperty(_this, "renderBgColor", function (isShowBgColorGroup, group, canvasTimeStart, canvasTimeEnd, canvasWidth) {
      ...
      if (!isShowBgColorGroup || isHide || isEmptyGroup || isEmptySubGroup || !minBeginDate || !maxEndDate) {
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
        style: {
          ...
          top: 0,
          left: left,
          height: "".concat(HEIGHT_ROW_TASK, "px"),
    ...
    _defineProperty(_this, "handleMouseDown", function (e) {
      ...
      if (!isCreateTaskList || (0, _calendar.checkValueDate)(group === null || group === void 0 || (_group$task = group.task) === null || _group$task === void 0 ? void 0 : _group$task.begin_date) && (0, _calendar.checkValueDate)(group === null || group === void 0 || (_group$task2 = group.task) === null || _group$task2 === void 0 ? void 0 : _group$task2.end_date) || !!(group !== null && group !== void 0 && group.isEmptyGroup)) {
        return;
      }
  ...
  return _createClass(GroupRow, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, !(group !== null && group !== void 0 && group.isHide) || group !== null && group !== void 0 && group.isMerge ? /*#__PURE__*/_react["default"].createElement(_PreventClickOnDrag["default"], {
        ...
        style: style
      }, this.renderBorderTaskList(group), this.renderCreateTask(group, countTime, left, width), this.renderBgColor(isShowBgColorGroup, group, canvasTimeStart, canvasTimeEnd, canvasWidth))) : /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null));
    }
  }]);
}(_react.Component);
