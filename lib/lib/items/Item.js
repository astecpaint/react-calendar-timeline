...
var Item = exports["default"] = /*#__PURE__*/function (_Component) {
  function Item(_props) {
    ...
    _defineProperty(_this, "onMouseMove", function (e) {
      ...
      if (!_this.props.isGembaMode || !_this.props.isHoverToSelectedItem) return;
    ...
    _defineProperty(_this, "onMouseLeave", function () {
      if (!_this.props.isHoverToSelectedItem || !_this.props.isGembaMode || _this.startedClickingCustom) return;
