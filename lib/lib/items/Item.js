...
var Item = exports["default"] = /*#__PURE__*/function (_Component) {
  function Item(_props) {
     ...
     */
    _defineProperty(_this, "getSortableClassName", function (item, group) {
      var _item$task, _item$task2;
      ...
      var parentId = item === null || item === void 0 || (_item$task = item.task) === null || _item$task === void 0 ? void 0 : _item$task.parent_id;
      var taskId = item === null || item === void 0 || (_item$task2 = item.task) === null || _item$task2 === void 0 ? void 0 : _item$task2.task_id;
      var belongTaskId = item === null || item === void 0 ? void 0 : item.belongTaskId;
      var belongTaskParentId = item === null || item === void 0 ? void 0 : item.belongTaskParentId;
      var customId = group === null || group === void 0 ? void 0 : group.customId;
      var sortableClassNames = [' sortable', " sortable-item-".concat(item === null || item === void 0 ? void 0 : item.group)];
      if (parentId || belongTaskParentId) {
        sortableClassNames.push(" ".concat(ONE, "--").concat(taskId || belongTaskId));
      }
      sortableClassNames.push(" ".concat(TWO, "--").concat(parentId || taskId || belongTaskParentId || belongTaskId));
      if (customId) {
    ...
    _defineProperty(_this, "getItemProps", function () {
      ...
      var sortableClassNameStr = _this.getSortableClassName(_this.props.item, _this.props.group);
      var classNames = 'rct-item' + (_this.props.item.className ? " ".concat(_this.props.item.className) : '') + sortableClassNameStr;
      return {
        key: _this.itemId,
    ...
    _defineProperty(_this, "getNewDimensionsTop", function (dimensionsTop) {
      var _this$props = _this.props,
        ...
        isShowInforGemba = _this$props.isShowInforGemba,
