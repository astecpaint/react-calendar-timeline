  ...
  return _createClass(Items, [{
    ...
    value: function render() {
      ...
      var _this$props2 = this.props,
        ...
        isShowInforGemba = _this$props2.isShowInforGemba;
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
        ...
        var isItemMove = currentGroupMoveId !== null && currentGroupMoveId !== undefined ? (item === null || item === void 0 || (_item$task = item.task) === null || _item$task === void 0 ? void 0 : _item$task.parent_id) === currentGroupMoveId || (item === null || item === void 0 || (_item$task2 = item.task) === null || _item$task2 === void 0 ? void 0 : _item$task2.task_id) === currentGroupMoveId || (item === null || item === void 0 ? void 0 : item.belongTaskParentId) === currentGroupMoveId || (item === null || item === void 0 ? void 0 : item.belongTaskId) === currentGroupMoveId : false;
        return !!(groupOrders !== null && groupOrders !== void 0 && (_groupOrders$item$gro = groupOrders[item === null || item === void 0 ? void 0 : item.group]) !== null && _groupOrders$item$gro !== void 0 && _groupOrders$item$gro.isShow) || isItemMove || (item === null || item === void 0 ? void 0 : item.isTemporaryProcess);
      }).map(function (item) {
        ...
        return /*#__PURE__*/_react["default"].createElement(_Item["default"], {
          ...
          canMove: _this.props.canMove && (0, _generic._get)(item, 'canMove'),
...
_defineProperty(Items, "propTypes", {
  ...
  isShowInforGemba: _propTypes["default"].bool.isRequired
});
